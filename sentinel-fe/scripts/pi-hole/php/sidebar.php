            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    if ($pistatus == 53) {
                        ...
                        echo '<span id="status"><i class="fa fa-w fa-circle text-red"></i> SENTINEL disabled</span>';
                    } elseif ($pistatus == -1) {
                    ...
                    if ($memory_usage > 0.0) {
                        echo '"></i> Memory:&nbsp;&nbsp;'.sprintf('%.1f', 100.0 * $memory_usage).'&thinsp;%</span>';
                    } else {
                        echo '"></i> Memory:&nbsp;&nbsp; N/A</span>';
                    }
                    ?>
                    <br/>
                    <?php
                ...
                <li class="menu-system treeview<?php if (in_array($scriptname, array('messages.php', 'gravity.php', 'queryads.php', 'auditlog.php', 'taillog.php', 'taillog-FTL.php', 'debug.php', 'network.php'))) { ?> active<?php } ?>">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="<?php if ($scriptname === 'messages.php') { ?> active<?php } ?>">
                            <a href="messages.php">
                                <i class="fa fa-fw menu-icon fa-file-medical-alt"></i> SENTINEL diagnosis
