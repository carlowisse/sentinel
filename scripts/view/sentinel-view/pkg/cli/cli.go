...
import (
	...
	"github.com/carlowisse/sentinel/tree/main/scripts/view/sentinel-view/pkg/database"
	"github.com/carlowisse/sentinel/tree/main/scripts/view/sentinel-view/pkg/ui"
	"github.com/urfave/cli/v2"
)

/*
	This is the main CLI app, it contains all the various commands and subcommands
	that Sentinel View is capable of responding to, and manages all of their corresponding flags
*/
var App = cli.App{
	Name:        "Sentinel View",
