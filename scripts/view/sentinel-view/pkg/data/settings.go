...
// Store SentinelView settings
var SENTINELVIEWSettings = NewSettings()

// Constant values required by Sentinel View
const (
	...
	ConfigFileName = "sentinel-view-config.json"
)

// Settings contains the current configuration options being used by Sentinel View
